...
def get_eurosat(datapath=".", image_size=224):
    ...
    # Path to the dataset
    data_dir = '/kaggle/input/eurosat-dataset/EuroSAT'  # Update if different
...
train_dataset, val_dataset, test_dataset = get_eurosat()
